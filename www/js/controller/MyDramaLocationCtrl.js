    ...
    var getMyDramaLocationDetail = function (id) {
      httpService.get("/script/getLocationDetail/" + id, {
        ...
        $scope.Location = {
          ...
          picname: response.data.data.pic_info[0].pic,
          ispublic: 1,
          pic_info:[{
            pic:"",
            txt:"",
        ...
        $scope.Location.pic_info.pic = response.data.data.pic_info[0].pic_url;
        $scope.Location.pic_info.txt=$scope.Location.pic_info.txt;
        $scope.Location.weather=$scope.weather[response.data.data.weather-1];
